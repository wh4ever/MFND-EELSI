...
class LXRTXLayer(nn.Module):  # cross-encoder模块
    def __init__(self, config):
        super().__init__()
...
class LXRTEncoder(nn.Module):
    ...
    def forward(self, lang_feats, lang_attention_mask,
                visn_feats, vision_attention_mask=None):  # 交叉注意力机制，传入语意特征，视觉特征，语意掩码矩阵，图像掩码矩阵
        ...
        extended_visual_attention_mask = vision_attention_mask.unsqueeze(1).unsqueeze(2)
